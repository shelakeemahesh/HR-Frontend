...
const navItems = [
  ...
  { label: 'Recruitment', path: '/recruitment', badge: 'AI', icon: (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            >
              ...
              {(!collapsed || mobileOpen) && (
                <div className="flex items-center justify-between flex-1 min-w-0">
                  ...
                  {item.badge && (
                    <span className="px-1.5 py-0.5 text-[10px] font-extrabold uppercase tracking-wider rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-sm shadow-indigo-500/20">
                      {item.badge}
                    </span>
                  )}
                </div>
